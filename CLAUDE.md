...
- **Core trade logic** `packages/thetanuts`: round 1 `1b457c4`; both review legs RED (`.research/thetanuts/review-r1-claude.md`, `sol-core-review-r1.final.md`). Round 2 fold running from `.research/thetanuts/brief-core-fold-r2.md` (10 findings, F1 contract round-trip and F2 taker-sell gate are blockers). After it lands: re-measure, then reviewer r2.
