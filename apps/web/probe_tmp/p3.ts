...
console.log(JSON.stringify({
  ...
  isLong: f.order.rawApiData!.isLong,
  isCall: f.order.rawApiData!.isCall,
  implementation: f.order.rawApiData!.implementation,
  premium: f.event.premiumAmount.toString(),
  fee: f.event.feeCollected.toString(),
  nonce: f.event.nonce.toString(),
  maker: f.order.makerAddress,
  buyer: f.event.buyer, seller: f.event.seller,
  sellerWasMaker: f.event.sellerWasMaker,
  debit: debit.toString(),
  extraOptionData: f.order.rawApiData!.extraOptionData,
}, null, 2));
