...
export function WalletBar() {
	...
	// B-m3, from the teammate's `use-session-mismatch`: a wallet connected as
	// somebody else signs the stale SERVER session out, rather than only hiding
	...
	// Named, and named exactly this, because `use-session-mismatch.test.ts` pins
	// the line: the chip and the actions must read ONE predicate so they cannot
