...
- **23:28 +0800:** live site link added to the submission (`https://nuts-web-kappa.vercel.app/`, the team's Vercel deploy; answered 200 with the app). Commit "Add live site link (Vercel)". NOTE: the production database holds only migration 0000 until the review is GREEN and 0001–0008 are applied.
